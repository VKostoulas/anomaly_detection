...
if __name__ == '__main__':
    ...
    if s.MODE == 'test':
        ...
        # experiment_1_global_params = {'TRAIN_BATCH_SIZE': 32,
        #                               'INFER_BATCH_SIZE': 64,
        ...
        #                               }
        #
        # experiment_2_global_params = {'TRAIN_BATCH_SIZE': 32,
        #                               'INFER_BATCH_SIZE': 64,
        #                               'OPTIMIZER_PARAMS': {'lr': 0.001},
        #                               'AUTOENCODER_ARCHITECTURE': 'SimpleAutoEncoder',
        #                               'AUTOENCODER_PARAMS':
        ...
        #                               }
        #
        # experiment_3_global_params = {'TRAIN_BATCH_SIZE': 4,
        #                               'INFER_BATCH_SIZE': 32,
        ...
        experiment_4_global_params = {'TRAIN_BATCH_SIZE': 4,
                                      'INFER_BATCH_SIZE': 32,
                                      'OPTIMIZER_PARAMS': {'lr': 0.0001},
                                      'AUTOENCODER_ARCHITECTURE': 'AdvancedAutoEncoder',
                                      'AUTOENCODER_PARAMS':
        ...
        experiments_params = [experiment_4_global_params]
